            ...
            <div class="row">
              <div class="col-12">
                <a-form-item name="country">
                  <a-select v-model:value="formState.country" placeholder="Country/Region *"
              ...
              <div class="col-12" v-if="formState.addressType == 0">
                <a-form-item name="prefecture">
                  <a-input v-model:value="formState.prefecture" placeholder="例：都道府県(東京都) *">
                  </a-input>
                </a-form-item>
              </div>
              ...
              <div class="col-12">
                <a-form-item name="address2">
                  <a-input v-model:value="formState.address2"
                    :placeholder="formState.addressType == 0 ? '例：いちご東池袋ビル9F' : 'Address2'">
                  </a-input>
                </a-form-item>
              </div>
              ...
              <div class="col-12 mt-2">
                <a-form-item name="payment">
                  <a-radio-group v-model:value="payment">
                    ...
                    <a-radio value="2"><img src="../../assets/payment2.png" alt="" /></a-radio>
                  </a-radio-group>
                </a-form-item>
              </div>
            </div>
